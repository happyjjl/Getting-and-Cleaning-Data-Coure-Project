...
The raw data was collected by experiments:
...
The first 2 variables 'subject' and 'activity' can uniquely identify each row of the table. The rest 86 variables are the averages for some selected features those which contain informations on means and standard deviations from the original dataset.
...
labels columns with descriptive names from 'features.txt'  
